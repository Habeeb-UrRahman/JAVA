...
public class SuperMarketBill {  
        public static void main(String args[]) {  
                ...
                System.out.println("\t\t\t\t\t "+"  "+"Capital Supermarket");  
                System.out.println("\t\t\t\t\t318-90/AB4, Kanuru, Vijayawada");  
                System.out.println("\t\t\t\t\t" +"Opposite Time Hospital, Vijayawada");  
                System.out.println("GSTIN: 03AWBPP8756K592"+"\t\t\t\t\t\t\tContact: (+91) 9834892490");  
                //format of date and time  
                SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");    
                Date date = new Date();    
                Calendar calendar = Calendar.getInstance();  
                String[] days = new String[] { "Sunday", "Monday", "Tuesday", "Wednesday", "Fhursday", "Friday", "Saturday" };  
                ...
                System.out.println(" "); 
                System.out.println("\t\t\t\t\t"+customername+"'s "+"bill ");
